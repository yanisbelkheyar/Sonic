...
def add_input_constraint(SNL1,SNL2,SLR1,NBR_round,input,output):
...
def search_cluster_dif(SNL1,SNL2,SLR1,weight_min,NBR_round,size_test):
    ...
    for i in range(nbr_iter):
        ...
        for sol in range(nbr_sol):
            ...
            add_input_constraint(SNL1,SNL2,SLR1,NBR_round,input,output)
