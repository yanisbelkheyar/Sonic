...
def search_cluster_lin(SNL1,SNL2,SLR1,SLL1,SLL2,SLL3,M,weight_min,NBR_round,size_test):
    ...
    for i in range(nbr_iter):
        ...
        #P.write("test_sonic_dif_"+str(SONIC_SIZE)+"_"+str(NBR_round)+".lp")
        ...
        for sol in range(nbr_class_solution):
            ...
            P.setParam(GRB.Param.PoolSearchMode,2)
            P.setParam(GRB.Param.PoolGap,1000)
